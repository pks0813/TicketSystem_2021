...
class Corn{
    ...
    Corn():UserBPT("User.in"),TrainBPT("TrainBPT.in"),StationTrainBPT("StationTrainBPT.in"),UserTimeBPT("UserTimeBPT.in"),
            ...
            Userpool("Userpool.in",1000),Trainpool("Trainpool.in",500),Orderpool("Orderpool.in",1000),Seatpool("Seatpool.in",2000),Stationpool("Stationpool.in",500),Useronline(10007),MPS(107)
            {
            std::fstream info;
