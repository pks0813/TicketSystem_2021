...
class Corn{
    ...
    Corn():UserBPT("User.in"),TrainBPT("TrainBPT.in"),StationTrainBPT("StationTrainBPT.in"),UserTimeBPT("UserTimeBPT.in"),
            ...
            Userpool("Userpool.in",10000)/*1M*/,Trainpool("Trainpool.in",5000)/*10M*/,Orderpool("Orderpool.in",15000)/*2M*/,Seatpool("Seatpool.in",8000)/*3M*/,Stationpool("Stationpool.in",2500)/*7.5M*/,Useronline(10007),MPS(107)
            {
            std::fstream info;
