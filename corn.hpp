...
class Corn{
    ...
    Corn():UserBPT("User.in"),TrainBPT("TrainBPT.in"),StationTrainBPT("StationTrainBPT.in"),UserTimeBPT("UserTimeBPT.in"),
            ...
            Userpool("Userpool.in",15000),Trainpool("Trainpool.in",9000),Orderpool("Orderpool.in",10000),Seatpool("Seatpool.in",8000),Stationpool("Stationpool.in",5000),Useronline(10007),MPS(107)
            {
            std::fstream info;
