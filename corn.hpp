...
class Corn{
    ...
    Corn():UserBPT("UserBPT.in"),TrainBPT("TrainBPT.in"),StationTrainBPT("StationTrainBPT.in"),UserTimeBPT("UserTimeBPT.in"),
            ...
            Userpool("Userpool.in",8000)/*1M*/,Trainpool("Trainpool.in",8000)/*14M*/,Orderpool("Orderpool.in",10000)/*2M*/,Seatpool("Seatpool.in",10000)/*6M*/,Stationpool("Stationpool.in",2000)/*6M*/,Useronline(10007),MPS(107)
