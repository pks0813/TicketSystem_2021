    ...
    public:
        ...
        public:
            ...
            int operator-(const iterator &rhs) const {
                //TODO
                if (this->pVector != rhs.pVector) throw invalid_iterator();
        ...
        T & at(const size_t &pos) {
            if (pos < 0 || pos >= this->length) throw index_out_of_bound();
         ...
         */
        const T & front() const {
            if (this->length == 0) throw container_is_empty();
            return *(this->data[0]);
        }
        /**
        ...
        iterator insert(const size_t &ind, const T &value) {
            if (ind < 0 || ind > this->length) throw index_out_of_bound();
